<template>
  ...
  >
    <div
      v-if="participant.cameraStatus === DeviceStatus.Off && participant.screenShareStatus === DeviceStatus.Off"
  ...
  <div
    v-else
    class="host-away-container"
  >
    <Avatar
      size="xxl"
      :src="currentRoom?.roomOwner.avatarUrl"
      :user-id="currentRoom?.roomOwner.userId"
    />
  </div>
</template>
